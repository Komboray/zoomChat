...
import socket
import threading
#to get public ip addresses we need the one below or visit (myip.is)
import requests

#we need to get the local ip address through cmd it is 192.168.184.1

#the other way to get it is by
local_ip_address = socket.gethostbyname(socket.gethostname())

#we call the public ip address as shown below
...
#GUI
window = tk.Tk()
window.title("Nyalife Clinic video calls")
